...
def createConfig():
    ...
    config['input'] = {'wordlist': f"{files('files').joinpath('jwt-common.txt')}",
        'commonHeaders': f"{files('files').joinpath('common-headers.txt')}",
        'commonPayloads': f"{files('files').joinpath('common-payloads.txt')}"}
    print(config['input']['wordlist'])
...
def scanModePlaybook():
    ...
    if headDict['alg'][:2] == "HS" or headDict['alg'][:2] == "hs":
        ...
        config['argvals']['keyList'] = f"{files('files').joinpath('jwt-common.txt')}"
    ...
    if headDict['alg'][:2] != "HS" and headDict['alg'][:2] != "hs":
        ...
        with open(files("files").joinpath("jwks-common.txt"), "r", encoding='utf-8', errors='ignore') as jwksLst:
